#include "MultiplayerModeScreen.h"
...
MultiplayerModeScreen::MultiplayerModeScreen(SDL_Renderer* r, TTF_Font* tf, TTF_Font* f)
...
void MultiplayerModeScreen::handle(const SDL_Event& e) {
    Screen::handle(e);
    if (e.type == SDL_KEYDOWN && e.key.keysym.sym == SDLK_ESCAPE) finished = true;
}

void MultiplayerModeScreen::render(SDL_Renderer* r, TTF_Font* f) {
